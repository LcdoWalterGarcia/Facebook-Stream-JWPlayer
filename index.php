	...
	<div class="container">
		...
		<form id="action-form" action="action.php" method="POST" accept-charset="utf-8">
			<div class="form-group">
				...
				<input type="text" name="link" class="form-control" placeholder="Ex: https://www.facebook.com/elwaitejavier/videos/2040536062830593"this.select()" required>
			</div>
